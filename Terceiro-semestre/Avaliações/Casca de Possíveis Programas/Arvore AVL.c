...
void inicializar(struct tNo **); //inicializar a arvore 
int menu();
void rotacaoSD(struct tNo **); //rotação simples direita 
void rotacaoSE(struct tNo **); //rotação simples esquerda  
void balancearAVL(struct tNo **); //função para deixar a arvore balanceada fica na inclusao e exclusao
void incluir(struct tNo **, struct tNo *);
void preordem(struct tNo *); //raiz, esquerda, direita
void emordem(struct tNo *); //esquerda, raiz, direita
void posordem(struct tNo *); //esquerda, direita, raiz 
void calcH(struct tNo *, int *); //calculo da altura de um nó
int fb(struct tNo *);  //calcula o fator de balanceamento 
struct tNo *consultar(struct tNo *, int );
void altFB(struct tNo *, int , int ); //mostra um nó consultado em detalhes 
int grau(struct tNo *); //informa o grau de um nó
